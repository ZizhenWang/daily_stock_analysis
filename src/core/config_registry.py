...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "FUTU_ENABLED": {
        "title": "Enable Futu OpenAPI",
        "description": "Enable Futu OpenAPI / OpenD market data provider.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "FUTU_HOST": {
        ...
        "description": "Host of the OpenD gateway, e.g. 127.0.0.1.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FUTU_PORT": {
        ...
        "description": "Port of the OpenD gateway, default 11111.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "FUTU_MARKETS": {
        "title": "Futu Markets",
        "description": "Comma-separated enabled markets for Futu, e.g. us,hk or cn,us,hk.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FUTU_PRIORITY": {
        "title": "Futu Priority",
        "description": "Priority of FutuFetcher in the historical-data fallback chain (smaller is earlier).",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GALAXY_ENABLED": {
        "title": "Galaxy Enabled",
        "description": "Enable AmazingData / 银河星耀数智 as an A-share history and fundamental source.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GALAXY_HOST": {
        "title": "Galaxy Host",
        "description": "AmazingData server host provided by Galaxy Securities.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "GALAXY_PORT": {
        "title": "Galaxy Port",
        "description": "AmazingData server port provided by Galaxy Securities.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GALAXY_USERNAME": {
        "title": "Galaxy Username",
        "description": "AmazingData login username.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": True,
    ...
    "GALAXY_PASSWORD": {
        "title": "Galaxy Password",
        "description": "AmazingData login password.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GALAXY_LOCAL_PATH": {
        "title": "Galaxy Local Path",
        "description": "Local cache path used by AmazingData financial/history APIs.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/galaxy",
        "options": [],
        "validation": {},
        "display_order": 21,
    },
    "GALAXY_PRIORITY": {
        "title": "Galaxy Priority",
        "description": "Priority of GalaxyFetcher in the historical-data fallback chain (smaller is earlier).",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GALAXY_HISTORY_ENABLED": {
        "title": "Galaxy History Enabled",
        "description": "Enable AmazingData query-style historical daily K-line fetch.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SCHEDULE_JOBS_JSON": {
        "title": "Schedule Jobs JSON",
        "description": "Optional multi-job schedule definition. When set, the schedule service registers each job from this JSON array instead of only using SCHEDULE_TIME.",
        "category": "system",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
