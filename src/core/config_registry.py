...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "GALAXY_BRIDGE_URL": {
        "title": "Galaxy Bridge URL",
        "description": "HTTP base URL of the remote Galaxy bridge service.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "GALAXY_BRIDGE_TOKEN": {
        "title": "Galaxy Bridge Token",
        "description": "Optional bearer token used when calling the remote Galaxy bridge service.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GALAXY_BRIDGE_TIMEOUT_SECONDS": {
        "title": "Galaxy Bridge Timeout Seconds",
        "description": "HTTP timeout when calling the remote Galaxy bridge service.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GALAXY_PRIORITY": {
        ...
        "description": "Priority of GalaxyFetcher (bridge mode) in the historical-data fallback chain (smaller is earlier).",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "GALAXY_HISTORY_ENABLED": {
        ...
        "description": "Enable Galaxy bridge historical daily K-line fetch.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
